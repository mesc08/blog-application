...
public class AppConstants {
    ...
    public static final Integer CREATED_STATUS_CODE = 202;
    public static final Integer BAD_STATUS_CODE = 400;
    public static final Integer NOTFOUND_STATUS_CODE = 400;
    ...
    public static final Integer CATEGORY_TITLE_SIZE = 3;
    ...
    public static final Integer CATEGORY_DESCRIPTION_SIZE = 8;
    ...
    public static final Integer USER_PASSWORD_SIZE = 8;
    ...
    public static final Integer POST_CONTENT_COLUMN_SIZE = 100000;
    public static final Integer POST_TITLE_SIZE = 100;
